let productList = [
	  ...
	  like: 54, review:412},
	  { title: '[본사]LAP 설맞이 신상 BEST 니트/가디건/원피스 단독가!' , size: '[ 55, 66 ]' ,
	  price:79000 , sale: 19000, discount: 0.75, img:'본사.jpg',
	  like: 54, review:412},
	  { title: '[SOUP/비지트인뉴욕] 본사 최종 시즌오프 BIG SALE! 가디건/니트/원피스/코트' , size: '[ 55, 66 ]' ,
	  price:10000 , sale: 9900, discount: 0.1, img:'비지트인뉴옥.jpg',
	  like: 54, review:412},
	  { title: '[샐리]겨울 시즌OFF 코트/자켓/점퍼/니트 BEST 아이템 모음' , size: '[ 55, 66 ]' ,
	  price:10000 , sale: 9900, discount: 0.1, img:'샐리.jpg',
	  like: 54, review:412},
	  { title: '[조이너스/NNF 외] 여성의류 F/W 역대급 초특가세일! 3900원부터~' , size: '[ 55, 66 ]' ,
	  price:10000 , sale: 9900, discount: 0.1, img:'조이너스.jpg',
	  like: 54, review:412},
	  { title: '[쉬즈미스/르오트 외] 겨울신상+BEST 아우터/이너' , size: '[ 55, 66 ]' ,
		...
		html +=  `
				...
				<div class="item_info">				<!-- 제품정보 구역 -->
					...
					<div> 
						...
						<span class="item_discount">${o.discount * 100}%</span>	<!-- 할인률 -->
					</div>
				</div>
